...
const ShareModule = (function() {
    ...
    function drawResultImage() {
        ...
        // === 中部：左侧文字 + 右侧人物漫画 ===
        // 右侧人物（占 700-1020 区域，中心 860,540）
        drawCharacter(ctx, 860, 560, currentResult.type);
    ...
    // === 16型古风人物漫画（Canvas 绘制）===
    // 每型一个色调 + 一个性格符号
    function drawCharacter(ctx, cx, cy, type) {
        const palette = {
            ...
            ">
                ...
                ">
                    ...
                    ">
                        ...
                        <div style="font-size: 13px; color: ${colors.inkLight}; line-height: 1.8; font-family: 'Noto Serif SC', serif; max-height: 100px; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 4; -webkit-box-orient: vertical;">${currentResult.desc || ''}</div>
                    </div>
